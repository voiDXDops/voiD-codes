...
/*Knapsack problem: In other words, given a set of items, each with a weight and a value, the goal is to determine 
which items to include in the knapsack so that the total value is maximized, 
while the total weight does not exceed a specified limit.*/
